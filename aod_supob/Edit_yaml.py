...
window_begin = date_anl - timedelta(hours=3)
window_end = date_anl + timedelta(hours=3)
...
#cmd='./gdas_obsprovider2ioda.x '+gdas_yaml_temp
cmd='/scratch1/NCEPDEV/da/Yaping.Wang/global/global-workflow_20240913/global-workflow/sorc/gdas.cd/build/bin/gdas_obsprovider2ioda.x '+gdas_yaml_temp
