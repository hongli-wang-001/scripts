...
def update_mpas_file(output_file, surface_pressure_val, u_zonal_val, u_merid_val, pressure_val, theta_val):
...
update_mpas_file(
    mpas_copy_b,
    surface_pressure-interp_surface,
    uReconstructZonal-interp_u,
    uReconstructMeridional-interp_v,
    pressure_p-interp_p,
    theta-interp_theta
)
