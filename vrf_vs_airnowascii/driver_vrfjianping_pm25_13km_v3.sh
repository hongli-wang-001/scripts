...
# check ncl file
export std=2020090112
export etd=2020092712

exp="v150_a"
#export out=/scratch2/BMC/wrfruc/hwang/wf1/post/out_case2020sep/${exp}
export out=/scratch2/BMC/rcm1/Megan.Bela/fv3/regional/data/rrfs-cmaq/${exp}
export obsdir=/scratch2/BMC/wrfruc/hwang/wf1/data/pm2p5_airnow_case2020sep/decode_bufr/hour 
#/scratch2/BMC/wrfruc/hwang/wf1/data/PM/hour 
...
#   export outdir=${out}/$std/pm25
   export outdir=${out}/$year/$month$dd/pm25
...
#   export std=$(/home/Ruifang.Li/bin/bumpidx ${std} 6)
   export std=`/home/Hongli.Wang/bin_theia/da_advance_time.exe $std 24h` 
done
