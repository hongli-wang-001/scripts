...
#I: 14 J: K:7
#rm FieldsMetadataDefault.cmaq.T70
#touch FieldsMetadataDefault.cmaq.T70
...
foreach avar (aolgaj alvoo1j alvoo2j asvoo1j asvoo2j asvoo3j apcsoj  aso4k   asoil   acors   aseacat aclk    ano3k   anh4k )

cat <<EOF >> FieldsMetadataDefault.cmaq.T70  
    md.longName = "$avar";
    md.shortName = "$avar";
    md.units = "kgkg-1";
    md.kind = "double";
