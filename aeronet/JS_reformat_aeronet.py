...
# In[ ]:
start_time_reformat='2020-09-01'
end_time_reformat='2020-09-30'
...
dates = pd.date_range(start=str(start_time_reformat),end=str(end_time_reformat),freq='H')
# set the output filename
#outname = 'AERONET_L15_20190901_20190930.nc'
outname = 'AERONET_'+str(start_time_reformat)+'_'+str(end_time_reformat) + '.nc'
