...
jdiag = "./data/hofx/adpupa_hofx.nc4"
...
plt.suptitle(f"Temperature {plot_var} at Level: {lev+1}", fontsize = 9, y = 1.05)
...
if plot_var == "Increment":
    plt.savefig(f"./increment_{variable}_lev{lev+1}.png", dpi=250, bbox_inches='tight')
