...
#        print(data[:1102])  # Print a few sample values for debugging
        
        data_masked = np.ma.masked_equal(data, missing_value)  # Mask missing values
#        print(f"Masked data from {group_name}:")
#        print(data_masked[:1102])  # Print a few sample masked values for debugging

        # Apply limits to ensure valid statistics
...
#    print(data_flat[:1102])  # Print a few sample values for debugging
