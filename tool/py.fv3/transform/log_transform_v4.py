...
# Determine bins and x-axis range for transformed data
...
for group, transformed_data in transformed_data_dict.items():
    ...
    x_axis_ranges[group] = (min_val, max_val)
...
for i, group in enumerate(groups):
    ...
    axes[1, i].set_xticks(np.linspace(x_range[0], x_range[1], num=5))  # Adjust x-ticks for better visualization

# Adjust layout and save the figure
plt.tight_layout()
plt.savefig('frequency_distribution_before_after_log_transform_adjusted_xaxis.png')
