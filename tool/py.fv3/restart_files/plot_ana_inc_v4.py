    ...
    try:
        ...
        with nc.Dataset(input_netcdf_file, 'r') as ds:
            ...
            with nc.Dataset(grid_file, 'r') as grid_ds:
                lats = grid_ds.variables['grid_latt'][:,:]  # Replace with actual variable names
                lons = grid_ds.variables['grid_lont'][:,:]  # Replace with actual variable names
