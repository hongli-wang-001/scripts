...
# Scatter plot
#scatter = ax.scatter(tlon, tlat, s=5, c=pm, linewidth=0.50, cmap=cmap, edgecolor='none', vmin=min_pm, vmax=max_pm)
#scatter = ax.scatter(tlon, tlat, s=5, c=pm, linewidth=0.50, cmap=cmap, edgecolor='none')
