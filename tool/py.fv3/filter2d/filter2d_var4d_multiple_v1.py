...
output_netcdf_file = 'filtered_sigma2_output.nc'
variables = [
...
def process_variable(input_file, variable_name, sigma, output_file):
    try:
        ...
        # Apply the Gaussian filter to each 2D slice in the time and vertical dimensions
