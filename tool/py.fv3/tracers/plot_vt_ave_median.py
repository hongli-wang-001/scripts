...
plt.plot(z, mean_data, marker='o', linestyle='-', color='b', label='Average')
plt.plot(z, median_data, marker='x', linestyle='--', color='r', label='Median')
...
plt.savefig('average_median_data_plot.png')  # Save the figure with the desired filename
print("Figure saved as 'average_median_data_plot.png'.")
