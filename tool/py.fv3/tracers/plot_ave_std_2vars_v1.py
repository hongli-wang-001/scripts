...
plt.errorbar(mean_ano3k, z, yerr=std_ano3k, label='ano3k', fmt='-o', color='blue', capsize=5)

# Plot average and standard deviation for anh4k
plt.errorbar(mean_anh4k, z, yerr=std_anh4k, label='anh4k', fmt='-x', color='red', capsize=5)
...
plt.savefig('average_with_error_bars_plot.png')  # Save the figure with the desired filename
print("Figure saved as 'average_with_error_bars_plot.png'.")
