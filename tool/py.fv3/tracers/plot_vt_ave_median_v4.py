...
plt.savefig('average_median_data_plot_inverted_z.png')  # Save the figure with the desired filename
print("Figure saved as 'average_median_data_plot_inverted_z.png'.")
