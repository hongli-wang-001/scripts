...
#python3 -u ./viirs_aod2ioda_org.py -n 0.999  -i JRR-AOD_v2r3_npp_s202009131852325_e202009131853567_c202009131930410.nc -o aod.nc -m nesdis -k maskout 
python3 -u ./viirs_aod2ioda_org.py -n 0.999  -i  JRR-AOD_v2r3_npp_s202009121908356_e202009121909598_c202009121948310.nc  -o aod.nc -m nesdis -k maskout 
