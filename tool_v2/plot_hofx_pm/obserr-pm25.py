...
myvalues=[0.1,0.2, 0.4, 0.6, 1.0, 1.5, 2.0, 3.0, 5.0, 7.0, 10.0]

f1=nc.Dataset(sys.argv[1],'r')
tlon=f1['MetaData/longitude'][:]
tlat=f1['MetaData/latitude'][:]
pm=f1['ObsError/particulatematter2p5Surface'][:]
print_stats(pm, "Error")
...
cbar.set_label('PM2.5 Error ($\mu$g/m$^3$)',fontsize=16)
