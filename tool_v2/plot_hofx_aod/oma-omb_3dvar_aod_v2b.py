...
myvalues=[-1.5, -1.0,-0.7, -0.5,-0.3, -0.2, -0.1,-0.05,-0.01,0.01,0.05,0.1, 0.3,0.4,0.5, 0.7, 1.0, 1.5]
...
pma=oaod-aaod
pmb=oaod-baod
#f1['ObsValue/particulatematter2p5Surface'][:]-f1['hofx0/particulatematter2p5Surface'][:]
product = pma * pmb
