...
truncations = [30]  # Truncate the DCT coefficients at these levels
...
# Save the figure
plt.tight_layout()
plt.savefig('dct_truncation_reconstruction_z63_z58_sameWL.png')
print("DCT truncation reconstruction for z=63 and z=58 figure saved as 'dct_truncation_reconstruction_z63_z58_sameWL.png'.")
