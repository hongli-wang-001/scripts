...
# Save the figure
plt.tight_layout()
plt.savefig('dct_truncation_reconstruction_with_scales_updated.png')
print("DCT truncation reconstruction with updated scales figure saved as 'dct_truncation_reconstruction_with_scales_updated.png'.")
