...
def calculate_wavelengths(u_freq, v_freq):
    ...
    min_wavelength = np.min(wavelengths[np.isfinite(wavelengths)])
...
# Save the figure
plt.tight_layout()
plt.savefig('dct_truncated_reconstruction_with_corrected_wavelength.png')
print("DCT truncated reconstruction with corrected wavelength figure saved as 'dct_truncated_reconstruction_with_corrected_wavelength.png'.")
